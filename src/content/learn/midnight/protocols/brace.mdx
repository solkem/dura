...
tier: "free"
difficulty: "advanced"
description: "Blind Registration via Anonymous Commitment Enrollment — devices register on-chain without revealing their identity."
tags: ["protocol", "privacy", "registration", "zkp"]
prerequisites: ["zkp"]
related: ["did", "nullifier"]
references: []
projects: ["msingi"]

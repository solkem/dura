...
description: "Elimination of trusted intermediaries through keysplitting, where no single party holds the full private key."
tags: ["architecture", "security", "multisig", "mpc"]
prerequisites: ["zkp"]
related: ["mpc", "multisig", "secure-enclave"]
references: []
